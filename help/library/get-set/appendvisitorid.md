...
>[!IMPORTANT]
>
>Als u wilt dat de waarden die via appendVisitorsIDsTo in de URL zijn doorgegeven, worden opgehaald, [OvewriteCrossDomainMCIDAndAID](../function-vars/overwrite-visitor-id.md) variable must be set to true.
